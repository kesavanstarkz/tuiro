...
export function useCreateGroupAssignment() { const c = useQueryClient(); return useMutation({ mutationFn: groupsApi.createAssignment, onSuccess: () => invalidate(c, [["student"], ["groups"]]) }); }
